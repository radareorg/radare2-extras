...
TARGET_X86_OLLY=arch_x86_olly.${LIBEXT}

ALL_TARGETS+=${TARGET_X86_OLLY}

arch_x86_olly.o: arch_x86_olly.c
	$(CC) -c $(CFLAGS) $< -o $@

${TARGET_X86_OLLY}: ${OBJ_X86_OLLY}
	${CC} $(call libname,arch_x86_olly) ${LDFLAGS} ${CFLAGS} -o ${TARGET_X86_OLLY} ${OBJ_X86_OLLY}
